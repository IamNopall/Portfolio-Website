<template>
    ...
    <div v-else class="page min-h-[100dvh] bg-[var(--bg)] text-[var(--text)] selection:bg-white selection:text-black">
        ...
        <header
            ...
            <div
                class="max-w-7xl mx-auto px-4 sm:px-8 h-16 sm:h-20 flex items-center justify-between font-sans text-[10px] sm:text-[11px] tracking-[0.2em] uppercase">
                <!-- Back Link -->
        ...
        <main class="pt-24 sm:pt-32">
            ...
            <section class="max-w-7xl mx-auto px-4 sm:px-8 pb-16 sm:pb-28">
                ...
                <div
                    class="flex flex-wrap items-center justify-between gap-4 pb-8 mb-8 sm:mb-12 border-b border-[var(--border-subtle)] font-sans text-[10px] sm:text-[11px] tracking-[0.25em] text-[var(--muted)] uppercase">
                    <div class="flex items-center gap-3">
                        <span class="text-[var(--heading)] font-mono font-semibold">PROJECT ARCHIVE // {{ project.year
                            }}</span>
                ...
                <div class="mb-10 sm:mb-16">
                    <h1
                        class="display-font font-black uppercase text-[15vw] sm:text-[11vw] lg:text-[8.5rem] leading-[0.84] tracking-tighter text-[var(--heading)] mb-6 select-none">
                        {{ project.title }}
                    </h1>
                    <p
                        class="font-sans text-base sm:text-xl lg:text-2xl text-[var(--text-soft)] max-w-3xl font-light leading-relaxed">
                        {{ project.shortDescription }}
                    </p>

                    <!-- Action Links (GitHub, Demo, Docs) -->
                    <div
                        class="flex flex-wrap items-center gap-4 sm:gap-6 pt-8 mt-8 border-t border-[var(--border-subtle)] font-sans text-xs tracking-[0.18em] uppercase">
                        <a v-if="project.githubUrl" :href="project.githubUrl" target="_blank" rel="noopener noreferrer"
                            class="project-action-btn group inline-flex items-center gap-2.5 px-5 py-2.5 font-semibold cursor-pointer">
                        ...
                        <a v-if="project.liveUrl" :href="project.liveUrl" target="_blank" rel="noopener noreferrer"
                            class="project-action-btn group inline-flex items-center gap-2.5 px-5 py-2.5 font-semibold cursor-pointer active:scale-[0.98]">
                ...
                <div v-if="project.heroImage"
                    class="relative w-full aspect-[16/9] sm:aspect-[21/9] bg-[var(--hover-bg)] border border-[var(--border-subtle)] overflow-hidden shadow-2xl group">
                    ...
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-[var(--bg)]/70 via-transparent to-transparent pointer-events-none opacity-60">
                    </div>
                </div>
            </section>
            ...
            <section class="w-full bg-[var(--bg)] border-t border-[var(--border-subtle)] py-20 sm:py-32">
                <div class="max-w-7xl mx-auto px-4 sm:px-8">
                    <div class="grid grid-cols-1 lg:grid-cols-[0.35fr_0.65fr] gap-12 lg:gap-20">
                        ...
                        <div>
                            <span
                                class="font-sans text-[10px] tracking-[0.25em] text-[var(--muted)] uppercase block mb-3">
                                01 // CONTEXT &amp; PURPOSE
                            </span>
                            <h2
                                class="display-font text-4xl sm:text-6xl font-black uppercase tracking-tighter text-[var(--heading)] leading-[0.9]">
                                PROJECT<br />OVERVIEW.
                            </h2>
                        </div>
                        ...
                        <div class="space-y-10">
                            <div>
                                <h3
                                    class="font-sans text-xs tracking-[0.2em] uppercase text-[var(--heading)] font-semibold mb-4">
                            ...
                            <div v-if="project.problemSolution"
                                class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-[var(--border-subtle)]">
                                <div class="space-y-3 p-6 bg-[var(--hover-bg)]/50 border border-[var(--border-subtle)]">
                                    <span
                                        class="font-mono text-[9px] tracking-[0.2em] text-red-400 uppercase font-semibold">
                                        CHALLENGE // PROBLEM
                                    </span>
                                    <p
                                ...
                                <div class="space-y-3 p-6 bg-[var(--hover-bg)]/50 border border-[var(--border-subtle)]">
                                    <span
                                        class="font-mono text-[9px] tracking-[0.2em] text-emerald-400 uppercase font-semibold">
                                        ENGINEERED SOLUTION
                                    </span>
                                    <p
                                        class="font-sans text-xs sm:text-sm text-[var(--text-soft)] font-light leading-relaxed">
            ...
            <section class="w-full bg-[var(--bg)] border-t border-[var(--border-subtle)] py-20 sm:py-28">
                <div class="max-w-7xl mx-auto px-4 sm:px-8">
                    <div
                        class="flex flex-col sm:flex-row sm:items-baseline justify-between gap-4 mb-10 pb-6 border-b border-[var(--border-subtle)]">
                        <div>
                            <span
                                class="font-sans text-[10px] tracking-[0.25em] text-[var(--muted)] uppercase block mb-2">
                    ...
                    <div class="flex flex-wrap gap-3 sm:gap-4">
                        <div v-for="tech in (project.technologies || [])" :key="tech"
                            ...
                            <span
                                class="w-1.5 h-1.5 rounded-full bg-[var(--heading)]/40 group-hover:bg-[var(--heading)] transition-colors"></span>
                            <span
                                class="font-sans text-xs sm:text-sm tracking-[0.15em] uppercase text-[var(--text-soft)] group-hover:text-[var(--heading)] transition-colors font-medium">
                                {{ tech }}
                            </span>
                        </div>
                    </div>
            ...
            <section v-if="project.features && project.features.length > 0"
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-8">
                    <!-- Section Header -->
                    <div
                        class="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-16 sm:mb-24 pb-8 border-b border-[var(--border-subtle)]">
                        <div>
                            <span
                                class="font-sans text-[10px] tracking-[0.25em] text-[var(--muted)] uppercase block mb-3">
                            ...
                            <h2
                                class="display-font text-5xl sm:text-7xl font-black uppercase tracking-tighter text-[var(--heading)] leading-none">
                                KEY FEATURES.
                            </h2>
                        </div>
                        <p class="font-sans text-xs sm:text-sm text-[var(--muted)] max-w-sm font-light">
                            Detailed architectural inspection of implemented gameplay mechanics, UI layers, and system
                            loops.
                        </p>
                    </div>
                        ...
                        <div v-for="feature in project.features" :key="feature.number"
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center gap-4">
                                    <span
                                        class="display-font text-5xl sm:text-6xl font-black text-[var(--heading)] opacity-30 select-none">
                                        {{ feature.number }}
                                    </span>
                                    <span class="w-8 h-[1px] bg-[var(--border-subtle)]"></span>
                                    <span v-if="feature.tech"
                                        class="font-mono text-[9px] sm:text-[10px] tracking-[0.2em] text-[var(--muted)] uppercase">
                                        {{ feature.tech }}
                                    </span>
                                </div>

                                <h3
                                    class="display-font text-3xl sm:text-5xl font-black uppercase text-[var(--heading)] tracking-tight leading-[0.9]">
                                    {{ feature.title }}
                                </h3>

                                <p
                                    class="font-sans text-sm sm:text-base text-[var(--text-soft)] font-light leading-relaxed">
                                    {{ feature.description }}
                                </p>
                            </div>
                            ...
                            <div
                                class="relative w-full aspect-[16/10] bg-[var(--hover-bg)] border border-[var(--border-subtle)] group-hover:border-[var(--border)] overflow-hidden shadow-xl transition-all duration-500">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-8">
                    <div class="grid grid-cols-1 lg:grid-cols-[0.35fr_0.65fr] gap-12 lg:gap-20">
                        ...
                        <div class="space-y-12">
                            <div>
                                <h3
                                    class="font-sans text-xs tracking-[0.2em] uppercase text-[var(--heading)] font-semibold mb-3">
                            ...
                            <div v-if="project.result.metrics && project.result.metrics.length > 0"
                                ...
                                <div v-for="metric in project.result.metrics" :key="metric.label" class="space-y-2">
                                    <div
                                        class="display-font text-4xl sm:text-5xl lg:text-6xl font-black text-[var(--heading)] tracking-tighter leading-none">
                                        {{ metric.value }}
                                    </div>
                                    <div
                                        class="font-sans text-[10px] sm:text-[11px] tracking-[0.18em] uppercase text-[var(--muted)] font-medium leading-tight">
                                        {{ metric.label }}
                                    </div>
                                </div>
                            </div>
            ...
            <section v-if="project.gallery && project.gallery.length > 0"
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-8">
                    <div
                        class="flex flex-col sm:flex-row sm:items-baseline justify-between gap-4 mb-12 sm:mb-16 pb-6 border-b border-[var(--border-subtle)]">
                        <div>
                            <span
                                class="font-sans text-[10px] tracking-[0.25em] text-[var(--muted)] uppercase block mb-2">
                            ...
                            <h2
                                class="display-font text-4xl sm:text-6xl font-black uppercase tracking-tighter text-[var(--heading)]">
                                PROJECT GALLERY.
                            </h2>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10">
                        <div v-for="(item, idx) in project.gallery" :key="idx" @click="openLightbox(item.url)"
                            ...
                            <div v-if="item.title || item.caption" class="pt-3 border-t border-[var(--border-subtle)]">
                                <h4 v-if="item.title"
                                    class="font-sans text-xs font-semibold tracking-wider text-[var(--heading)] uppercase mb-1">
                                    {{ item.title }}
                                </h4>
                                <p v-if="item.caption"
            ...
            <section class="w-full bg-[var(--bg)] border-t border-[var(--border-subtle)] py-20 sm:py-28">
                <div class="max-w-7xl mx-auto px-4 sm:px-8">
                    <div
                        class="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-[var(--border-subtle)] border border-[var(--border-subtle)]">
                        <!-- PREVIOUS PROJECT -->
                        <router-link v-if="adjacent.prev" :to="'/projects/' + adjacent.prev.slug"
                            ...
                            <span
                                class="font-sans text-[10px] tracking-[0.25em] text-[var(--muted)] uppercase mb-6 flex items-center gap-2">
                                <span class="transform group-hover:-translate-x-1 transition-transform">←</span>
                                <span>PREVIOUS WORK</span>
                            </span>
                            <div>
                                <span
                                    class="font-mono text-[9px] tracking-wider text-[var(--muted)] uppercase block mb-1">
                                    {{ adjacent.prev.category }}
                                </span>
                                <h3
                                    class="display-font text-3xl sm:text-5xl font-black uppercase text-[var(--heading)] group-hover:text-[var(--text-soft)] transition-colors leading-[0.9] tracking-tight">
                                    {{ adjacent.prev.title }}
                                </h3>
                            </div>
                        </router-link>
                        <div v-else class="p-8 sm:p-12 opacity-30 flex items-center">
                            <span class="font-sans text-xs tracking-widest text-[var(--muted)] uppercase">FIRST WORK IN
                                ARCHIVE</span>
                        </div>
                        ...
                        <router-link v-if="adjacent.next" :to="'/projects/' + adjacent.next.slug"
                            ...
                            <span
                                class="font-sans text-[10px] tracking-[0.25em] text-[var(--muted)] uppercase mb-6 flex items-center justify-end gap-2">
                                <span>NEXT WORK</span>
                                <span class="transform group-hover:translate-x-1 transition-transform">→</span>
                            </span>
                            <div>
                        ...
                        <div v-else class="p-8 sm:p-12 opacity-30 flex items-center justify-end text-right">
                            <span class="font-sans text-xs tracking-widest text-[var(--muted)] uppercase">LAST WORK IN
                                ARCHIVE</span>
                        </div>
                    </div>
                </div>
